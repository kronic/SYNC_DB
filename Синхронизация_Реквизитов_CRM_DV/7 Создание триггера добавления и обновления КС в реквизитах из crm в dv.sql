...
/*********************************************/
IF object_id('CRM_DV_KS', 'TR') IS NOT NULL
DROP TRIGGER CRM_DV_KS
GO
/*********************************************/

--Добавляем триггер. добовления  контактов в DV при добовление в CRM.
/*********************************************/
CREATE TRIGGER CRM_DV_KS
...
BEGIN
	...
	DECLARE		@_KS						varchar(20) -- DV type nvarchar(128) привод типа и длинны не нужен
