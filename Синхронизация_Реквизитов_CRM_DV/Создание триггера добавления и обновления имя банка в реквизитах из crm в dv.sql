...
/*********************************************/
IF object_id('CRM_DV_BANK_NAME', 'TR') IS NOT NULL
DROP TRIGGER CRM_DV_BANK_NAME
GO
/*********************************************/

--Добавляем триггер. добовления  контактов в DV при добовление в CRM.
/*********************************************/
CREATE TRIGGER CRM_DV_BANK_NAME
...
BEGIN
	...
	DECLARE		@_BANK_NAME					varchar(20) -- DV type nvarchar(128) привод типа и длинны не нужен
