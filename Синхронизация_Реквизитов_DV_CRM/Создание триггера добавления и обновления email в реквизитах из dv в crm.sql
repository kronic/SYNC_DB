...
/*********************************************/
IF object_id(N'DV_CRM_Upd_Req_email') IS NOT NULL
DROP TRIGGER DV_CRM_Upd_Req_email
GO
/*********************************************/

--Добавляем триггер. добовления  контактов в DV при добовление в CRM.
/*********************************************/
CREATE TRIGGER DV_CRM_Upd_Req_email
...
BEGIN
	...
	DECLARE		@_BEF_Email						nvarchar(128)
	DECLARE		@_AFT_Email						nvarchar(128)
