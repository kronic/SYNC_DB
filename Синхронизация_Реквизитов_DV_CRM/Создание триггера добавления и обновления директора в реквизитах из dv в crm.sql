...
/*********************************************/
IF OBJECT_ID(N'DV_CRM_Upd_Req_Dir_Name', 'TR') IS NOT NULL
DROP TRIGGER DV_CRM_Upd_Req_Dir_Name
GO
/*********************************************/

--Добавляем триггер. Обновления  телефона в DV при добовление в CRM.
/*********************************************/
CREATE TRIGGER	DV_CRM_Upd_Req_Dir_Name
...
BEGIN
	...
	/*********************************************/
	SELECT
	TOP 1		@_DV_ID_MANAGER			=		INS.Manager,
